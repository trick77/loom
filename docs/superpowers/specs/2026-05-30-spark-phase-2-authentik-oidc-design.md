...
- `SLOPR_OIDC_REDIRECT_URL`
- `SLOPR_OIDC_POST_LOGOUT_REDIRECT_URL`
- `SLOPR_OIDC_ADMIN_GROUP`

`SLOPR_SESSION_SECRET` remains required and signs transient auth state. `SLOPR_ADMIN_INITIAL_PASSWORD`
