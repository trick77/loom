...
Lume can already generate PPTX, PDF, DOCX, XLSX, and text artifacts (see
...
- **PPTX** defines a tasteful Lume color theme in `theme1.xml`, but no slide ever references it.
