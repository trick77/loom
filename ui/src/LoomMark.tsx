// The Loom spiral mark, inline so it can be optically sized: small instances use a
// heavier stroke than the full-size logo, and the color follows `currentColor`. The
// path matches src/assets/loom-logo.svg (24×24 viewBox); only the stroke weight is
// tunable here so the mark stays legible when rendered tiny (e.g. the "Thinking" label).
