...
SELECT m.id, m.thread_id, m.role, m.content, m.reasoning_content, m.tool_calls, m.citations, m.artifacts, m.attachments, m.activity_trace, m.content_blocks, m.prompt_tokens, m.completion_tokens, m.total_tokens, m.cached_tokens, m.reasoning_tokens, m.context_tokens, m.duration_ms, m.model, m.reasoning_effort, m.created_at
FROM messages m
WHERE m.user_id = ?
