...
type StreamResult struct {
	...
	Model            string
	// ReasoningEffort is the level this turn sent (see the reasoning note in
	// client.go). Blank on messages persisted while loom sent none; the metrics
	// pill omits the segment then.
